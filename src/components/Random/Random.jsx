...
const Random = () => {
    const {data:meal } = useFetch(`https://www.themealdb.com/api/json/v1/1/random.php`);
    const {data:meals, isPending, error } = useFetch(`https://www.themealdb.com/api/json/v1/1/random.php`);
